 ...
 */
public class UniquePokemonNameGenerator {
    ...
    /**
     * "Generates" an unique PokemonName
     */
    public UniquePokemonNameGenerator() {
        this.refresh();
    }
     ...
     */
    private final List<String> finalPokemons = Arrays.asList(
            "Bulbasaur",
            "Ivysaur",
            "Venusaur",
            "Charmander",
